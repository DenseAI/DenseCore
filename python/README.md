...
The `densecore` package provides native Python bindings for local GGUF inference.
...
The Python package does not install the Go CLI. For `densecore run` or
`densecore serve`, use the source-built CLI documented in
[`../docs/CLI.md`](../docs/CLI.md).

For DenseCore v0.1.0, the Python package is a beta/source-preview local
runtime surface versus the primary server path.
...
- [Main Repository](https://github.com/DenseAI/DenseCore)
- [API Reference](../docs/API_REFERENCE.md)
- [Deployment Guide](../docs/DEPLOYMENT.md)
- [CLI Guide](../docs/CLI.md)

Apache 2.0 License. Issues: <https://github.com/DenseAI/DenseCore/issues>
