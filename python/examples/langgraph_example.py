...
def example_4_tool_execution():
    ...
    def add_numbers(left: int, right: int) -> str:
        ...
        return f"The result is: {left + right}"
    ...
    result1 = tool_executor.invoke({"tool": "add_numbers", "tool_input": {"left": 15, "right": 7}})
    print(f"  {result1}")

    print("\nTesting word_count tool:")
    result2 = tool_executor.invoke(
        {"tool": "word_count", "tool_input": {"text": "Hello world from DenseCore"}}
    )
    print(f"  {result2}")
