...
DenseCore provides beta Python bindings for local CPU inference with GGUF models.

Supported Model Types:
    - LLMs: qualified model families documented by DenseCore
    - Embeddings: local text embedding helpers
