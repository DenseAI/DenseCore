...
TEST(ModelDescriptorTest, Qwen36TokenizerMetadataUsesQwen35UnicodeBpeFamily) {
    TransformerModel model{};
    model.arch = ModelArch::QWEN35;
...
TEST(ModelDescriptorTest, QwenTokenizerAliasesAreRecognizedWithoutCompatibilityWarning) {
    EXPECT_TRUE(densecore::models::IsKnownTokenizerModel("qwen3.6"));
    EXPECT_TRUE(densecore::models::IsKnownTokenizerModel("qwen3.8"));
