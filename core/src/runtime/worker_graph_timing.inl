...
bool IsGemma4NodeTimingDumpEnabled() {
    static const bool enabled = densecore::env::ParseDiagnosticEnv("DENSECORE_DEBUG_GEMMA4_NODE_TIMES", false);
    return enabled;
}

bool IsLLMNodeTimingDumpEnabled() {
    static const bool enabled = densecore::env::ParseDiagnosticEnv("DENSECORE_DEBUG_LLM_NODE_TIMES", false);
    return enabled;
}

int Gemma4NodeTimingDumpLimit() {
    return densecore::env::ParseDiagnosticPositiveEnvInt("DENSECORE_DEBUG_GEMMA4_NODE_TIMES_LIMIT", 24);
}

int LLMNodeTimingDumpLimit() {
    return densecore::env::ParseDiagnosticPositiveEnvInt("DENSECORE_DEBUG_LLM_NODE_TIMES_LIMIT", 24);
}
