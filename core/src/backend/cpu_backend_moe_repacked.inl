...
bool RunQ4KRepackedMoEGemv(const CpuExecutionOptions& options, CpuBackend* backend, const std::shared_ptr<Q4KRepackedMoEWeight>& packed,
...
bool RunQ5KRepackedMoEFusedSwiGLURawProjectionImpl(const CpuExecutionOptions& options, CpuBackend* backend, const void* gate_weight_ptr,
