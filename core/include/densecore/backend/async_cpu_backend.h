...
#include "densecore/backend/async_backend.h"
#include "densecore/backend/cpu_backend.h"  // Existing synchronous backend
...
public:
    ...
    std::future<void> MatMulAsync(KernelContext& ctx, const TensorView& A, const TensorView& B, TensorView& C) override;
