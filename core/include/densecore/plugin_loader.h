 ...
 */
#define DENSECORE_ENT_API_VERSION_MAJOR DENSECORE_ENT_ABI_VERSION_MAJOR
#define DENSECORE_ENT_API_VERSION_MINOR DENSECORE_ENT_ABI_VERSION_MINOR
#define DENSECORE_ENT_API_VERSION DENSECORE_ENT_ABI_VERSION
 ...
 */
typedef struct {
    uint32_t abi_version;   ///< Must have the same ABI major as the host
    uint32_t struct_size;   ///< sizeof(DenseCoreEntPluginInfo)
